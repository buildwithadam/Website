            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="flex items-center justify-between h-14">
                    ...
                    <nav className="hidden md:flex items-center gap-6 text-sm">
                        ...
                        <a href="/lab.html" className="text-neutral-300 hover:text-white transition-colors">Lab</a>
                ...
                <div className="grid lg:grid-cols-2 gap-10 items-center">
                    <div>
                        ...
                        <div className="mt-8 flex flex-wrap items-center gap-3">
                            ...
                            <a href="/lab.html" className="inline-flex items-center gap-2 rounded-xl px-5 py-3 text-sm font-medium border border-lime-300/40 hover:bg-lime-400/20 backdrop-blur-xl">
    ...
    return (
        <footer className="py-10 border-t border-white/10">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="text-xs opacity-60">Privacy • Terms • Email • <a href="/lab.html" className="underline">Lab</a></div>
            </div>
        </footer>
    );
}
